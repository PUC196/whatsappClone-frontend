...
const HomePage = () => {
  ...
  const handleCreateNewMessage = () => {
    ...
    const newMessage = {
      ...
      content: content,
      user: { id: auth.reqUser.id }, // make sure the correct user is included
    };
    console.log("In homePage handle create new message: ",newMessage);

    // Dispatch the new message to the backend
